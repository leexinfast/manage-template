...
<script>
    ...
    export default {
        ...
        methods: {
            initDetail() {
                Http.get('financial/audit/detail', {loanId:this.$route.query.id}).then(res => {
                    if(res.detail.car){
            ...
            handleSubmit() {
                ...
                Http.posts('financial/audit/submit',this.submitForm).then(res => {
            ...
            listBack(){
                this.$router.push('/financial/financial-list')
            }
        }
    }
</script>
