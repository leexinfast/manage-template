        ...
        <el-row>
            <el-table :data="tbList" border v-loading="tableLoading">
                ...
                <el-table-column label="操作">
                    <template slot-scope="scope">
                        <router-link :to="'/financial/financial-detail?id='+scope.row.id"><el-button type="primary" size="mini">详情</el-button></router-link>
                    </template>
                </el-table-column>
            </el-table>
        </el-row>
    ...
    export default {
        ...
        methods: {
            initList() {
                ...
                Http.get('financial/audit/list', this.searchForm).then(res => {
