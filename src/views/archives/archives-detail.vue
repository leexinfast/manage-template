...
<script>
    ...
    export default {
        ...
        methods: {
            initDetail() {
                Http.get('loan/archives/detail', {loanId:this.$route.query.id}).then(res => {
                    if(res.detail.car){
            ...
            handleSave() {
                ...
                Http.posts('loan/archives/save',this.submitForm).then(res => {
            ...
            handleSubmit() {
                ...
                this.submitForm.loanId = this.$route.query.id;
                Http.posts('loan/archives/submit',this.submitForm).then(res => {
            ...
            listBack(){
                this.$router.push('/archives/archives-list')
            }
        }
    }
</script>
