<template>
    <div class="app-container">
        ...
        <el-row class="le_main">
            <h3>操作</h3>
            <el-form :inline="true" ref="ruleForm" :rules="rule" :model="submitForm" label-width="110px" class="le_form_valid le_form_op">
                <el-form-item label="资料齐全日期：">
                    <el-date-picker size="small" type="date" value-format="yyyy-MM-dd" placeholder="资料齐全日期" v-model="submitForm.invoiceDate" :readonly="inputShow"></el-date-picker>
                </el-form-item>
            </el-form>
        </el-row>
...
<script>
    ...
    export default {
        ...
        methods: {
            initDetail() {
                Http.get('loan/material/detail', {loanId:this.$route.query.id}).then(res => {
                    if(res.detail.car){
            ...
            handleSave() {
                ...
                Http.posts('loan/material/save',this.submitForm).then(res => {
            ...
            handleSubmit() {
                ...
                this.submitForm.loanId = this.$route.query.id;
                Http.posts('loan/material/submit',this.submitForm).then(res => {
            ...
            listBack(){
                this.$router.push('/material/material-list')
            }
        }
    }
</script>
