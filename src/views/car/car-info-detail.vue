<template>
    <div class="app-container">
        ...
        <el-row class="le_main">
            <h3>操作</h3>
            <el-form :inline="true" ref="ruleForm" :rules="rule" :model="submitForm" label-width="95px" class="le_form_valid le_form_op">
                <el-form-item label="车辆品牌：">
                    <div class="le_form_item">{{submitForm.brand}}</div>
                </el-form-item>
                <el-form-item label="车型：">
                    <div class="le_form_item">{{submitForm.type}}</div>
                </el-form-item>
                <el-form-item label="车架号：">
                    <el-input class="le_input" v-model="submitForm.frameNo" placeholder="请输入" size="small" clearable :readonly="inputShow"></el-input>
                </el-form-item>
                <el-form-item label="开票单位：">
                    <el-input class="le_input" v-model="submitForm.invoiceUnit" placeholder="请输入" size="small" clearable :readonly="inputShow"></el-input>
                </el-form-item>
                <el-form-item label="车牌类型：">
                    <el-select v-model="submitForm.plateType" placeholder="请选择" size="small" clearable :readonly="inputShow">
                        <el-option label="公牌" value="公牌"></el-option>
                        <el-option label="私牌" value="私牌"></el-option>
                    </el-select>
                </el-form-item>
                <el-form-item label="登记车主：">
                    <el-input class="le_input" v-model="submitForm.registOwner" placeholder="请输入" size="small" clearable :readonly="inputShow"></el-input>
                </el-form-item>
                <el-col>
                    <el-form-item label="牌证上传：">
                        <el-upload
                ...
                <el-form-item label="发动机号：">
                    <el-input class="le_input" v-model="submitForm.engineNo" placeholder="请输入" size="small" clearable :readonly="inputShow"></el-input>
                </el-form-item>
                <el-form-item label="车辆颜色：">
                    <el-input class="le_input" v-model="submitForm.color" placeholder="请输入" size="small" clearable :readonly="inputShow"></el-input>
                </el-form-item>
                <el-form-item label="发票日期：">
                    <el-date-picker size="small" type="date" value-format="yyyy-MM-dd" placeholder="发票日期" v-model="submitForm.invoiceDate" :readonly="inputShow"></el-date-picker>
                </el-form-item>
                <el-form-item label="开票价：">
                    <el-input class="le_input" v-model="submitForm.invoicePrice" placeholder="请输入" size="small" clearable :readonly="inputShow"></el-input>
                </el-form-item>
            </el-form>
        </el-row>
...
<script>
    ...
    export default {
        ...
        methods: {
            initDetail() {
                Http.get('loan/car/detail', {loanId:this.$route.query.id}).then(res => {
                    if(res.detail.car){
                        ...
                        let obj = {
                            ...
                            color:car.color,
                            invoiceDate:car.invoiceDate,
                            invoicePrice:car.invoicePrice,
                            invoiceUnit:car.invoiceUnit,
                            plateType:car.plateType,
                            registOwner:car.registOwner
                        }
                        this.submitForm = obj;
                    }
            ...
            handleSave() {
                ...
                Http.posts('loan/car/save',this.submitForm).then(res => {
            ...
            handleSubmit() {
                ...
                this.submitForm.loanId = this.$route.query.id;
                Http.posts('loan/car/submit',this.submitForm).then(res => {
