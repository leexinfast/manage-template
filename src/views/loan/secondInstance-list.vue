    ...
    <div class="app-container">
            ...
            <el-form :inline="true" :model="searchForm" class="demo-form-inline le_form">
                ...
                <el-form-item label="经销商">
                    <el-select v-model="searchForm.dealerId" placeholder="请选择" size="small" clearable>
                        <el-option v-for="item,index in dealerList" :key="index" :label="item.name"
                ...
                <el-form-item label="资方">
                    <el-select v-model="searchForm.capitalId" placeholder="请选择" size="small" clearable>
                        <el-option v-for="item,index in capitalList" :key="index" :label="item.name"
                                   :value="item.id"></el-option>
                    </el-select>
                </el-form-item>
                <el-form-item>
        ...
        <el-row>
            <el-table :data="tbList" border v-loading="tableLoading">
                <el-table-column prop="statusShow" label="状态" width="180"></el-table-column>
                ...
                <el-table-column prop="carType" label="车辆型号" width="120"></el-table-column>
                <el-table-column prop="financingAmount" label="分期金额" width="120"></el-table-column>
                <el-table-column prop="monthRepay" label="月还款额" width="120"></el-table-column>
                <el-table-column prop="term" label="期数" width="120"></el-table-column>
                <el-table-column prop="tailAmount" label="尾款" width="120"></el-table-column>
                <el-table-column prop="capitalName" label="资方" width="120"></el-table-column>
                <el-table-column prop="dealerName" label="汽车经销商" width="120"></el-table-column>
                <el-table-column prop="dealerAccountName" label="业务人员" width="120"></el-table-column>
                <el-table-column prop="createTime" label="创建时间" width="180"></el-table-column>
                <el-table-column label="操作" width="120">
                    <template slot-scope="scope">
                        <router-link :to="'/loan/secondInstance-detail?id='+scope.row.id"><el-button type="primary" size="mini">详情</el-button></router-link>
                    </template>
                </el-table-column>
            </el-table>
        </el-row>
        <!-- 分页 -->
        <le-pagination v-show="totalPage > 0" :total="totalPage" :page.sync="pageNo"
                       @pagination="initList"></le-pagination>
    </div>
</template>
<script>
    ...
    export default {
        ...
        methods: {
            initList() {
                ...
                Http.get('secondInstance/list', this.searchForm).then(res => {
